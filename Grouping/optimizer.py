...
def MA_optmize(Dim, gene_len, func, random_Pop, NIND, Max_iter, intercept):
    ...
    MA_groups = help_Proposal.Phen_Groups(groups, help_Proposal.empty_groups(2 ** gene_len))
...
#     return MA_groups, current_best_Obj, cost
#
#
...
#         LS_cost += cost
#         obj = benchmark.object_function(base_fitness, groups_fitness, len(Empty_groups))
